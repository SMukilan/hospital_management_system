...
/**
 * Servlet Filter implementation class EditPatientFilter
 */
public class EditPatientFilter extends HttpFilter implements Filter
{
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException
	{
		...
		try
		{
			...
			{
				request.setAttribute("admissionNum", admissionNum);
